                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10 col-md-10">
                                <label class="radio-inline col-sm-2 col-md-2">
                                    <input type="radio" name="certType" id="idCard" value="1"/> 身份证
                                </label>
                                <label class="radio-inline col-sm-2 col-md-2">
                                    <input type="radio" name="certType" id="police" value="2"/> 警官证
                                </label>
                                <label class="radio-inline col-sm-2 col-md-2">
                                    <input type="radio" name="certType" id="signature" value="3"/> 电子签名
                                </label>
                                <label class="radio-inline col-sm-2 col-md-2">
                                    <input type="radio" name="certType" id="cachet" value="4"/> 电子公章
                                </label>
                            </div>
                        </div>
                        <div class="row">
